...
MSA = readRDS(paste0("/oak/stanford/groups/dpwall//users/briannac/phyloWAS/data/diabetes_150/msa_", msa_alg, ".rds"))
person_biomarker_dir = paste0("/oak/stanford/groups/dpwall/users/briannac/phyloWAS/results/diabetes_150/person_biomarker/", msa_alg, "/")
save_dir = paste0("/oak/stanford/groups/dpwall/users/briannac/phyloWAS/results/diabetes_150/p_vals/", msa_alg, "_")
...
### Perform phylo-was.
n_permutations = 100
phenotypes = sample_data(ps)$t1d == 'T1D' ## TO CHANGE: Change to whatever column has relevant phenotype!
