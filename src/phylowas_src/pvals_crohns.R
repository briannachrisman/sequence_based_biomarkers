...
MSA = readRDS(paste0("/oak/stanford/groups/dpwall/users/briannac/phyloWAS/data/crohns/msa_", msa_alg, ".rds"))
person_biomarker_dir = paste0("/oak/stanford/groups/dpwall/users/briannac/phyloWAS/results/crohns/person_biomarker/", msa_alg, "/")
save_dir = paste0("/oak/stanford/groups/dpwall/users/briannac/phyloWAS/results/crohns/p_vals/", msa_alg, "_")
